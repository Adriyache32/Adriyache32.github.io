  ...
  switch (tab) {
    ...
    case 'team': {
      const members = sd.team || [
        { name: 'Eliezer', role: 'Creador', color: '#f0c040', image: '' },
        { name: 'Manchitas', role: 'Creador', color: '#f0c040', image: '' },
        { name: 'Adriyache32', role: 'Moderador', color: '#4ecdc4', image: '' },
...
function addTeamMember() {
  const sd = getSD();
  const team = sd.team || [];
  team.push({ name: 'Nuevo', role: 'Miembro', color: '#7289da', image: '' });
  sd.team = team;
  localStorage.setItem(SERVER_DATA_KEY, JSON.stringify(sd));
  showCreatorTab('team');
}
...
function applyTeam() {
  ...
  grid.innerHTML = team.map(m => `
    <div class="member">
      ${m.image
        ? `<img class="member-avatar-img" src="${m.image}" alt="${m.name}">`
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  "kits": [
    {
      ...
      "price": 5,
      "perks": [
        "🪖 Armadura: Casco de cuero, Peto de cuero, Pantalones de cuero, Botas de cuero",
        "⛏️ Herramientas: Pico de madera, Hacha de madera, Espada de madera, Pala de madera",
        "🍞 Comida: 10 panes, 5 manzanas",
        "📦 Items: 16 antorchas, 1 Cama marrón",
        "🏷️ Tag coloreado en el chat"
      ],
      "badge": "GRATIS"
    },
    {
      ...
      "price": 5,
      "perks": [
        "🪖 Armadura: Casco de cota de malla, Peto de cota de malla, Pantalones de cota de malla, Botas de cota de malla",
        "⛏️ Herramientas: Pico de piedra, Hacha de piedra, Espada de piedra, Pala de piedra",
        "🍞 Comida: 20 filetes de res",
        "📦 Items: 32 antorchas, 1 Cama naranja, 1 Mesa de trabajo",
        "🏠 Home adicional (2 total)"
      ],
      "badge": ""
    },
    {
      ...
      "price": 10,
      "perks": [
        "🪖 Armadura: Casco de hierro, Peto de hierro, Pantalones de hierro, Botas de hierro",
        "⛏️ Herramientas: Pico de hierro, Hacha de hierro, Espada de hierro, Pala de hierro",
        "🍞 Comida: 15 chuletas de cerdo cocidas",
        "📦 Items: 24 antorchas, 1 Cama gris, 1 Mesa de encantamientos",
        "🔮 Acceso a /enderchest"
      ],
      "badge": ""
    },
    {
      ...
      "price": 20,
      "perks": [
        "🪖 Armadura: Casco de oro, Peto de oro, Pantalones de oro, Botas de oro",
        "⛏️ Herramientas: Pico de oro (Eficiencia II), Hacha de oro (Eficiencia II), Espada de oro, Pala de oro (Eficiencia II)",
        "🍞 Comida: 30 filetes de res, 10 pasteles de calabaza",
        "📦 Items: 48 antorchas, 1 Cama amarilla, 1 Yunque, 3 Libros",
        "💰 5 monedas del server"
      ],
      "badge": "RECOMENDADO"
    },
    {
      ...
      "price": 40,
      "perks": [
        "🪖 Armadura: Casco de diamante, Peto de diamante, Pantalones de diamante, Botas de diamante",
        "⛏️ Herramientas: Pico de diamante (Fortuna III), Hacha de diamante (Eficiencia III), Espada de diamante (Filo III), Pala de diamante (Eficiencia III)",
        "🍞 Comida: 40 filetes de res, 20 pasteles de calabaza",
        "📦 Items: 64 antorchas, 1 Cama celeste, 1 Cofre de ender, 5 Obsidiana, 1 Perla de ender"
      ],
      "badge": ""
    },
    {
      ...
      "price": 80,
      "perks": [
        "🪖 Armadura: Casco de diamante (Protección II), Peto de diamante (Protección II), Pantalones de diamante (Protección II), Botas de diamante (Protección II)",
        "⛏️ Herramientas: Pico de diamante (Fortuna III, Eficiencia III), Hacha de diamante (Eficiencia III, Filo III), Espada de diamante (Filo III, Saqueo II), Pala de diamante (Eficiencia III)",
        "🍞 Comida: 64 filetes de res, 32 pasteles de calabaza, 8 manzanas doradas",
        "📦 Items: 64 antorchas, 1 Cama verde, 1 Cofre de ender, 16 Obsidiana, 5 Perlas de ender, 1 Huevo de dragón"
      ],
      "badge": ""
    },
    {
      ...
      "price": 160,
      "perks": [
        "🪖 Armadura: Casco de diamante (Protección III), Peto de diamante (Protección III), Pantalones de diamante (Protección III), Botas de diamante (Protección III)",
        "⛏️ Herramientas: Pico de diamante (Fortuna IV, Eficiencia IV), Hacha de diamante (Eficiencia IV, Filo IV), Espada de diamante (Filo IV, Saqueo II), Pala de diamante (Eficiencia IV)",
        "🍞 Comida: 50 filetes de res, 20 pasteles de calabaza, 10 manzanas doradas",
        "📦 Items: 64 antorchas, 1 Cama roja, 1 Cofre de ender, 10 Obsidiana, 3 Perlas de ender"
      ],
      "badge": "NUEVO"
    },
    {
      ...
      "price": 320,
      "perks": [
        "🪖 Armadura: Casco de netherite, Peto de netherite, Pantalones de netherite, Botas de netherite",
        "⛏️ Herramientas: Pico de netherite (Fortuna V), Hacha de netherite (Eficiencia V), Espada de netherite (Filo V), Pala de netherite (Eficiencia V)",
        "🍞 Comida: 64 filetes de res, 32 pasteles de calabaza, 32 manzanas doradas",
        "📦 Items: 64 antorchas, 1 Cama negra, 1 Cofre de ender, 32 Obsidiana, 10 Perlas de ender, 1 Huevo de dragón, 1 Totem de inmortalidad"
      ],
      "badge": "NUEVO"
    },
    {
      ...
      "price": 640,
      "perks": [
        "🪖 Armadura: Casco de netherite (Protección V, Casco de acuático), Peto de netherite (Protección V), Pantalones de netherite (Protección V, Caída de pluma IV), Botas de netherite (Protección V, Caída de pluma IV, Agilidad acuática)",
        "⛏️ Herramientas: Pico de netherite (Fortuna V, Eficiencia V, Irrompibilidad III), Hacha de netherite (Eficiencia V, Filo V, Irrompibilidad III), Espada de netherite (Filo V, Aspecto ígneo II, Saqueo III, Barrido III, Irrompibilidad III), Pala de netherite (Eficiencia V, Irrompibilidad III), Azada de netherite (Eficiencia V, Irrompibilidad III)",
        "🍞 Comida: 64 chuletas de res, 32 pasteles de calabaza, 64 manzanas doradas notches",
        "📦 Items: 64 antorchas, 1 Cama negra, 1 Cofre de ender, 64 Obsidiana, 16 Perlas de ender, 1 Huevo de dragón, 1 Totem de inmortalidad, 1 Élitatra (Reparación III, Protección IV), 1 Escudo (Reparación III), 1 Ballesta (Multidisparo, Perforación IV, Velocidad de cargado III)",
        "💰 50 monedas del server"
      ],
      "badge": "NUEVO"
    }
  ],
  ...
  "membresias": [
    ...
    },
    {
      ...
      "badge": "👑 VIP",
      "perks": [
        "Tag especial + color + brillo",
        "5 homes adicionales",
        "Acceso a /fly, /nick, /enderchest",
        "Rol VIP en Discord",
  ...
  "logros": [
    ...
    {"name":"Recolector","desc":"Consigue 20 de madera","icon":"🪵","tier":1,"reward":0.25},
    {"name":"Excavador","desc":"Cava 10 bloques de tierra","icon":"🫘","tier":1,"reward":0.25},
    {"name":"Fabricante","desc":"Crea tu primer mesa de trabajo","icon":"🪚","tier":1,"reward":0.25},
    {"name":"Horno","desc":"Funde 10 items en un horno","icon":"🔥","tier":1,"reward":0.25},
    {"name":"Antorcha","desc":"Crea 10 antorchas","icon":"🔦","tier":1,"reward":0.25},
    {"name":"Cama","desc":"Fabrica una cama","icon":"🛏️","tier":1,"reward":0.25},
    {"name":"Cofre","desc":"Crea y coloca un cofre","icon":"📦","tier":1,"reward":0.25},
    {"name":"Ventana","desc":"Crea 4 vidrios","icon":"🪟","tier":1,"reward":0.25},
    {"name":"Escalera","desc":"Crea 10 escaleras","icon":"🪜","tier":1,"reward":0.25},
    {"name":"Puerta","desc":"Crea una puerta de madera","icon":"🚪","tier":1,"reward":0.25},
    {"name":"Valla","desc":"Crea 6 vallas","icon":"🛡️","tier":1,"reward":0.25},
    {"name":"Losa","desc":"Crea 10 losas de piedra","icon":"🧱","tier":1,"reward":0.25},
    {"name":"Ladrillo","desc":"Funde un ladrillo","icon":"🧱","tier":1,"reward":0.25},
    {"name":"Palo","desc":"Crea 10 palos","icon":"🥢","tier":1,"reward":0.25},
    {"name":"Mesa de Encantamientos","desc":"Crea una mesa de encantamientos","icon":"📖","tier":1,"reward":0.25},
    {"name":"Yunque","desc":"Crea un yunque","icon":"🔨","tier":1,"reward":0.25},
    {"name":"Hogar","desc":"Pone tu cama en una casa","icon":"🏠","tier":1,"reward":0.25},
    {"name":"Cosecha","desc":"Planta y cosecha 5 trigos","icon":"🌾","tier":1,"reward":0.25},
    {"name":"Papa","desc":"Planta y cosecha 5 papas","icon":"🥔","tier":1,"reward":0.25},
    {"name":"Zanahoria","desc":"Planta y cosecha 5 zanahorias","icon":"🥕","tier":1,"reward":0.25},
    {"name":"Melón","desc":"Cosecha 1 melón","icon":"🍈","tier":1,"reward":0.25},
    {"name":"Calabaza","desc":"Cosecha 1 calabaza","icon":"🎃","tier":1,"reward":0.25},
    {"name":"Caña de Azúcar","desc":"Corta 10 cañas de azúcar","icon":"🎋","tier":1,"reward":0.25},
    {"name":"Huevo","desc":"Consigue 5 huevos de gallina","icon":"🥚","tier":1,"reward":0.25},
    {"name":"Leche","desc":"Ordeña una vaca","icon":"🥛","tier":1,"reward":0.25},
    {"name":"Carne","desc":"Consigue 10 filetes de res","icon":"🥩","tier":1,"reward":0.25},
    {"name":"Pollo","desc":"Cocina 5 pollos","icon":"🍗","tier":1,"reward":0.25},
    {"name":"Pescado","desc":"Pesca 3 peces","icon":"🐟","tier":1,"reward":0.25},
    {"name":"Explorador","desc":"Camina 1000 bloques","icon":"👣","tier":1,"reward":0.25},
    {"name":"Colina","desc":"Sube a la montaña más alta","icon":"⛰️","tier":1,"reward":0.25},
    {"name":"Río","desc":"Cruza un río","icon":"🌊","tier":1,"reward":0.25},
    {"name":"Bosque","desc":"Encuentra un bosque","icon":"🌲","tier":1,"reward":0.25},
    {"name":"Oveja","desc":"Esquila 3 ovejas","icon":"🐑","tier":1,"reward":0.25},
    {"name":"Cerdo","desc":"Monta un cerdo","icon":"🐷","tier":1,"reward":0.25},
    {"name":"Gato","desc":"Domestica un gato","icon":"🐱","tier":1,"reward":0.25},
    {"name":"Perro","desc":"Domestica un lobo","icon":"🐶","tier":1,"reward":0.25},
    {"name":"Pesca","desc":"Crea una caña de pescar","icon":"🎣","tier":1,"reward":0.25},
    {"name":"Flecha","desc":"Crea 10 flechas","icon":"🏹","tier":1,"reward":0.25},
    {"name":"Arco","desc":"Crea un arco","icon":"🏹","tier":1,"reward":0.25},
    {"name":"Espada de Piedra","desc":"Crea una espada de piedra","icon":"🗡️","tier":1,"reward":0.25},
    {"name":"Pico de Piedra","desc":"Crea un pico de piedra","icon":"⛏️","tier":1,"reward":0.25},
    {"name":"Hacha de Piedra","desc":"Crea un hacha de piedra","icon":"🪓","tier":1,"reward":0.25},
    {"name":"Pala de Piedra","desc":"Crea una pala de piedra","icon":"🫘","tier":1,"reward":0.25},
    {"name":"Azada de Madera","desc":"Crea una azada de madera","icon":"🌾","tier":1,"reward":0.25},
    {"name":"Carbon","desc":"Consigue 10 carbones","icon":"🪨","tier":1,"reward":0.25},
    {"name":"Hueso","desc":"Consigue 5 huesos","icon":"🦴","tier":1,"reward":0.25},
    {"name":"Lana","desc":"Consigue 10 lanas","icon":"🧶","tier":1,"reward":0.25},
    {"name":"Cuero","desc":"Consigue 5 cueros","icon":"👜","tier":1,"reward":0.25},
    {"name":"Minero de Hierro","desc":"Consigue 20 lingotes de hierro","icon":"⛏️","tier":2,"reward":0.5},
    {"name":"Carbonífero","desc":"Consigue 64 carbón","icon":"🪨","tier":2,"reward":0.5},
    {"name":"Armadura de Hierro","desc":"Crea un set completo de armadura de hierro","icon":"🪖","tier":2,"reward":0.5},
    {"name":"Herramientas de Hierro","desc":"Crea pico, hacha, pala y espada de hierro","icon":"🔧","tier":2,"reward":0.5},
    {"name":"Escudo","desc":"Crea un escudo","icon":"🛡️","tier":2,"reward":0.5},
    {"name":"Encantador","desc":"Encanta un item por primera vez","icon":"✨","tier":2,"reward":0.5},
    {"name":"Libro Encantado","desc":"Consigue un libro encantado","icon":"📕","tier":2,"reward":0.5},
    {"name":"Manzana Dorada","desc":"Crea una manzana dorada","icon":"🍎","tier":2,"reward":0.5},
    {"name":"GApple","desc":"Crea una manzana dorada","icon":"🍎","tier":2,"reward":0.5},
    {"name":"Poción de Curación","desc":"Crea una poción de curación","icon":"🧪","tier":2,"reward":0.5},
    {"name":"Poción de Fuerza","desc":"Crea una poción de fuerza","icon":"💪","tier":2,"reward":0.5},
    {"name":"Poción de Velocidad","desc":"Crea una poción de velocidad","icon":"🏃","tier":2,"reward":0.5},
    {"name":"Poción de Salto","desc":"Crea una poción de salto","icon":"🦘","tier":2,"reward":0.5},
    {"name":"Redstone","desc":"Consigue 20 redstone","icon":"🔴","tier":2,"reward":0.5},
    {"name":"Lámpara","desc":"Crea una lámpara de redstone","icon":"💡","tier":2,"reward":0.5},
    {"name":"Palanca","desc":"Crea una palanca","icon":"🕹️","tier":2,"reward":0.5},
    {"name":"Botón","desc":"Crea un botón de piedra","icon":"🔘","tier":2,"reward":0.5},
    {"name":"Placa de Presión","desc":"Crea 2 placas de presión","icon":"⚡","tier":2,"reward":0.5},
    {"name":"Puerta de Hierro","desc":"Crea una puerta de hierro","icon":"🚪","tier":2,"reward":0.5},
    {"name":"Trampilla","desc":"Crea 2 trampillas","icon":"🪟","tier":2,"reward":0.5},
    {"name":"Carro","desc":"Crea un carro minero","icon":"🚂","tier":2,"reward":0.5},
    {"name":"Raíl","desc":"Crea 10 raíles","icon":"🛤️","tier":2,"reward":0.5},
    {"name":"Bote","desc":"Crea un bote","icon":"🚤","tier":2,"reward":0.5},
    {"name":"Montura","desc":"Consigue una montura","icon":"🐴","tier":2,"reward":0.5},
    {"name":"Mina","desc":"Excava 10x10 en una mina","icon":"🕳️","tier":2,"reward":0.5},
    {"name":"Acantilado","desc":"Encuentra un bioma de acantilados","icon":"🏔️","tier":2,"reward":0.5},
    {"name":"Desierto","desc":"Encuentra un desierto","icon":"🏜️","tier":2,"reward":0.5},
    {"name":"Taiga","desc":"Encuentra una taiga","icon":"🌲","tier":2,"reward":0.5},
    {"name":"Playa","desc":"Encuentra una playa","icon":"🏖️","tier":2,"reward":0.5},
    {"name":"Pantano","desc":"Encuentra un pantano","icon":"🌿","tier":2,"reward":0.5},
    {"name":"Lago de Lava","desc":"Encuentra un lago de lava","icon":"🌋","tier":2,"reward":0.5},
    {"name":"Cueva","desc":"Explora 5 cuevas diferentes","icon":"🕋","tier":2,"reward":0.5},
    {"name":"Aldea","desc":"Encuentra una aldea","icon":"🏘️","tier":2,"reward":0.5},
    {"name":"Templo","desc":"Encuentra un templo del desierto","icon":"🗿","tier":2,"reward":0.5},
    {"name":"Pozo","desc":"Encuentra un pozo en el desierto","icon":"🪣","tier":2,"reward":0.5},
    {"name":"Comerciante","desc":"Comercia con un aldeano","icon":"💼","tier":2,"reward":0.5},
    {"name":"Mesa de Cartografía","desc":"Usa una mesa de cartografía","icon":"🗺️","tier":2,"reward":0.5},
    {"name":"Cama de Color","desc":"Tiñe una cama","icon":"🛏️","tier":2,"reward":0.5},
    {"name":"Bandera","desc":"Crea una bandera","icon":"🏳️","tier":2,"reward":0.5},
    {"name":"Marco","desc":"Crea y usa un marco","icon":"🖼️","tier":2,"reward":0.5},
    {"name":"Plato","desc":"Crea 6 platos","icon":"🍽️","tier":2,"reward":0.5},
    {"name":"Iniciar Sesión","desc":"Juega por 5 horas totales","icon":"⏰","tier":2,"reward":0.5},
    {"name":"Día 10","desc":"Sobrevive 10 días","icon":"☀️","tier":2,"reward":0.5},
    {"name":"Cama Roja","desc":"Duerme 10 noches en cama","icon":"🌙","tier":2,"reward":0.5},
    {"name":"Cocinero","desc":"Cocina 30 comidas","icon":"🍳","tier":2,"reward":0.5},
    {"name":"Panadero","desc":"Hornea 20 panes","icon":"🍞","tier":2,"reward":0.5},
    {"name":"Pastel","desc":"Crea un pastel","icon":"🎂","tier":2,"reward":0.5},
    {"name":"Galleta","desc":"Hornea 10 galletas","icon":"🍪","tier":2,"reward":0.5},
    {"name":"Sopa","desc":"Crea una sopa de champiñones","icon":"🍲","tier":2,"reward":0.5},
    {"name":"Piedra Lisa","desc":"Crea 64 piedra lisa","icon":"🪨","tier":2,"reward":0.5},
    {"name":"Ladrillos de Piedra","desc":"Crea 64 ladrillos de piedra","icon":"🧱","tier":2,"reward":0.5},
    {"name":"Mina de Diamante","desc":"Consigue 10 diamantes","icon":"💎","tier":3,"reward":1},
    {"name":"Armadura de Diamante","desc":"Crea un set de armadura de diamante","icon":"🪖","tier":3,"reward":1},
    {"name":"Herramientas de Diamante","desc":"Crea pico, hacha, pala y espada de diamante","icon":"🔧","tier":3,"reward":1},
    {"name":"Fortuna","desc":"Encanta un pico con Fortuna III","icon":"🍀","tier":3,"reward":1},
    {"name":"Eficiencia","desc":"Encanta una herramienta con Eficiencia IV","icon":"⚡","tier":3,"reward":1},
    {"name":"Protección","desc":"Encanta una armadura con Protección IV","icon":"🛡️","tier":3,"reward":1},
    {"name":"Filo","desc":"Encanta una espada con Filo IV","icon":"🗡️","tier":3,"reward":1},
    {"name":"Poder","desc":"Encanta un arco con Poder IV","icon":"🏹","tier":3,"reward":1},
    {"name":"Toque de Seda","desc":"Consigue un encantamiento de Toque de Seda","icon":"🪄","tier":3,"reward":1},
    {"name":"Irrompibilidad","desc":"Encanta un item con Irrompibilidad III","icon":"🔩","tier":3,"reward":1},
    {"name":"Observador","desc":"Crea y usa 4 observadores","icon":"👁️","tier":3,"reward":1},
    {"name":"Comparador","desc":"Crea y usa un comparador","icon":"⚖️","tier":3,"reward":1},
    {"name":"Repetidor","desc":"Crea y usa 3 repetidores","icon":"🔄","tier":3,"reward":1},
    {"name":"Pistón","desc":"Crea 6 pistones","icon":"🤖","tier":3,"reward":1},
    {"name":"Pistón Pegajoso","desc":"Crea 4 pistones pegajosos","icon":"🖐️","tier":3,"reward":1},
    {"name":"TNT","desc":"Crea 10 TNT","icon":"💣","tier":3,"reward":1},
    {"name":"Granja Automática","desc":"Construye una granja de caña automática","icon":"⚙️","tier":3,"reward":1},
    {"name":"Ascensor","desc":"Construye un ascensor de agua","icon":"🛗","tier":3,"reward":1},
    {"name":"Puerta Oculta","desc":"Construye una puerta secreta","icon":"🤫","tier":3,"reward":1},
    {"name":"Sistema de Redstone","desc":"Construye un circuito con 10+ componentes","icon":"🔌","tier":3,"reward":1},
    {"name":"Reloj","desc":"Crea un reloj","icon":"⏱️","tier":3,"reward":1},
    {"name":"Brújula","desc":"Crea una brújula","icon":"🧭","tier":3,"reward":1},
    {"name":"Mapa","desc":"Crea y completa un mapa","icon":"🗺️","tier":3,"reward":1},
    {"name":"Balde de Agua","desc":"Crea 3 baldes","icon":"🪣","tier":3,"reward":1},
    {"name":"Tesoro","desc":"Encuentra un cofre de tesoro enterrado","icon":"💎","tier":3,"reward":1},
    {"name":"Ruina Oceánica","desc":"Explora una ruina oceánica","icon":"🏛️","tier":3,"reward":1},
    {"name":"Naufragio","desc":"Encuentra un naufragio","icon":"🚢","tier":3,"reward":1},
    {"name":"Glow Squid","desc":"Consigue tinta luminosa","icon":"🦑","tier":3,"reward":1},
    {"name":"Axolotl","desc":"Domestica un axolotl","icon":"🦎","tier":3,"reward":1},
    {"name":"Llamas","desc":"Domestica 2 llamas","icon":"🦙","tier":3,"reward":1},
    {"name":"Ocelote","desc":"Domestica un ocelote","icon":"🐆","tier":3,"reward":1},
    {"name":"Loro","desc":"Domestica un loro","icon":"🦜","tier":3,"reward":1},
    {"name":"Zorro","desc":"Domestica un zorro","icon":"🦊","tier":3,"reward":1},
    {"name":"Aldeano","desc":"Protege una aldea de invasión","icon":"🛡️","tier":3,"reward":1},
    {"name":"Bibliotecario","desc":"Comercia con un bibliotecario","icon":"📚","tier":3,"reward":1},
    {"name":"Herrero","desc":"Comercia con un herrero","icon":"🔨","tier":3,"reward":1},
    {"name":"Flechero","desc":"Comercia con un flechero","icon":"🏹","tier":3,"reward":1},
    {"name":"Carnicero","desc":"Comercia con un carnicero","icon":"🥩","tier":3,"reward":1},
    {"name":"Granjero","desc":"Comercia con un granjero 10 veces","icon":"🌾","tier":3,"reward":1},
    {"name":"Iniciar Sesión 2","desc":"Juega 20 horas totales","icon":"⏰","tier":3,"reward":1},
    {"name":"Día 25","desc":"Sobrevive 25 días","icon":"☀️","tier":3,"reward":1},
    {"name":"Muerte","desc":"Muere por primera vez","icon":"💀","tier":3,"reward":1},
    {"name":"Vuelta","desc":"Respawna después de morir","icon":"🔄","tier":3,"reward":1},
    {"name":"Anillo","desc":"Encuentra un anillo de luminiscente","icon":"💍","tier":3,"reward":1},
    {"name":"Luminiscente","desc":"Consigue 10 bloques de luminiscente","icon":"🌟","tier":3,"reward":1},
    {"name":"Esponja","desc":"Consigue una esponja","icon":"🧽","tier":3,"reward":1},
    {"name":"Prismarina","desc":"Consigue 20 prismarina","icon":"🔮","tier":3,"reward":1},
    {"name":"Coral","desc":"Consigue 10 corales diferentes","icon":"🪸","tier":3,"reward":1},
    {"name":"Pesca Tesoro","desc":"Pesca un item encantado","icon":"🎣","tier":3,"reward":1},
    {"name":"Netherita","desc":"Consigue 4 lingotes de netherita","icon":"🖤","tier":4,"reward":2},
    {"name":"Armadura de Netherita","desc":"Crea un set completo de netherita","icon":"🪖","tier":4,"reward":2},
    {"name":"Herramientas de Netherita","desc":"Crea pico, hacha, espada y pala de netherita","icon":"⚔️","tier":4,"reward":2},
    {"name":"Espada de Netherita","desc":"Crea una espada de netherita","icon":"🗡️","tier":4,"reward":2},
    {"name":"Portal al Nether","desc":"Construye y activa un portal al Nether","icon":"🌀","tier":4,"reward":2},
    {"name":"Explorador del Nether","desc":"Camina 500 bloques en el Nether","icon":"👣","tier":4,"reward":2},
    {"name":"Fortaleza","desc":"Encuentra una fortaleza del Nether","icon":"🏰","tier":4,"reward":2},
    {"name":"Blaze","desc":"Mata 10 Blaze","icon":"🔥","tier":4,"reward":2},
    {"name":"Wither Skeleton","desc":"Mata 10 Wither Skeletons","icon":"💀","tier":4,"reward":2},
    {"name":"Ghast","desc":"Mata 5 Ghasts","icon":"👻","tier":4,"reward":2},
    {"name":"Lágrima de Ghast","desc":"Consigue 3 lágrimas de ghast","icon":"💧","tier":4,"reward":2},
    {"name":"Piglin","desc":"Comercia con un Piglin 5 veces","icon":"🐷","tier":4,"reward":2},
    {"name":"Gold","desc":"Consigue 20 oro del Nether","icon":"🪙","tier":4,"reward":2},
    {"name":"Cuarzo","desc":"Consigue 64 cuarzo","icon":"💎","tier":4,"reward":2},
    {"name":"Bastión","desc":"Encuentra un bastión Piglin","icon":"🏛️","tier":4,"reward":2},
    {"name":"Poción de Resistencia al Fuego","desc":"Crea una poción de resistencia al fuego","icon":"🧪","tier":4,"reward":2},
    {"name":"Poción de Regeneración","desc":"Crea una poción de regeneración","icon":"❤️","tier":4,"reward":2},
    {"name":"Poción de Daño","desc":"Crea una poción de daño","icon":"💀","tier":4,"reward":2},
    {"name":"Flecha Espectral","desc":"Crea 10 flechas espectrales","icon":"🏹","tier":4,"reward":2},
    {"name":"Poción de Respiración","desc":"Crea una poción de respiración acuática","icon":"🫁","tier":4,"reward":2},
    {"name":"Ojos de Ender","desc":"Consigue 12 Ojos de Ender","icon":"👁️","tier":4,"reward":2},
    {"name":"Portal al End","desc":"Encuentra y activa el portal al End","icon":"🌀","tier":4,"reward":2},
    {"name":"Ender Dragon","desc":"Derrota al Ender Dragon","icon":"🐉","tier":4,"reward":2},
    {"name":"Regreso","desc":"Regresa del End con vida","icon":"🔄","tier":4,"reward":2},
    {"name":"Ciudad del End","desc":"Encuentra una ciudad del End","icon":"🏰","tier":4,"reward":2},
    {"name":"Elitra","desc":"Consigue un élitras","icon":"🪶","tier":4,"reward":2},
    {"name":"Cabeza de Dragon","desc":"Consigue la cabeza del dragón","icon":"🐉","tier":4,"reward":2},
    {"name":"Shulker","desc":"Mata 5 Shulkers","icon":"📦","tier":4,"reward":2},
    {"name":"Cofre de Shulker","desc":"Consigue un cofre de shulker","icon":"📦","tier":4,"reward":2},
    {"name":"Enderman","desc":"Mata 20 Endermans","icon":"👾","tier":4,"reward":2},
    {"name":"Perla de Ender","desc":"Consigue 16 perlas de ender","icon":"🔮","tier":4,"reward":2},
    {"name":"Construye","desc":"Construye una casa de 10x10","icon":"🏗️","tier":4,"reward":2},
    {"name":"Granja de Experiencia","desc":"Construye una granja de XP","icon":"📈","tier":4,"reward":2},
    {"name":"Granja de Aldeanos","desc":"Construye una granja de aldeanos","icon":"👨‍🌾","tier":4,"reward":2},
    {"name":"Almacén","desc":"Construye un almacén con 20 cofres","icon":"🏪","tier":4,"reward":2},
    {"name":"Granja de Mob","desc":"Construye una granja de mobs","icon":"⚙️","tier":4,"reward":2},
    {"name":"Invernadero","desc":"Construye un invernadero automático","icon":"🌱","tier":4,"reward":2},
    {"name":"Fundición","desc":"Construye una fundición con 8 hornos","icon":"🔥","tier":4,"reward":2},
    {"name":"Puerto","desc":"Construye un puerto con botes","icon":"⚓","tier":4,"reward":2},
    {"name":"Iniciar Sesión 3","desc":"Juega 50 horas totales","icon":"⏰","tier":4,"reward":2},
    {"name":"Día 50","desc":"Sobrevive 50 días","icon":"☀️","tier":4,"reward":2},
    {"name":"Viajero","desc":"Camina 50000 bloques totales","icon":"👣","tier":4,"reward":2},
    {"name":"Minero","desc":"Excava 5000 bloques","icon":"⛏️","tier":4,"reward":2},
    {"name":"Constructor","desc":"Coloca 5000 bloques","icon":"🧱","tier":4,"reward":2},
    {"name":"Pescador Experto","desc":"Pesca 100 veces","icon":"🎣","tier":4,"reward":2},
    {"name":"Cazador","desc":"Mata 500 mobs","icon":"⚔️","tier":4,"reward":2},
    {"name":"Amigos","desc":"Juega con 3 amigos diferentes","icon":"👥","tier":4,"reward":2},
    {"name":"Evento","desc":"Participa en un evento del server","icon":"🎉","tier":4,"reward":2},
    {"name":"Logro","desc":"Completa 50 logros diferentes","icon":"🏅","tier":4,"reward":2},
    {"name":"Veterano","desc":"Juega por 30 días diferentes","icon":"📅","tier":4,"reward":2},
    {"name":"Wither","desc":"Derrota al Wither","icon":"💀","tier":5,"reward":3},
    {"name":"Estrella del Nether","desc":"Consigue una estrella del Nether","icon":"⭐","tier":5,"reward":3},
    {"name":"Beacon","desc":"Construye un beacon","icon":"🔦","tier":5,"reward":3},
    {"name":"Beacon Completo","desc":"Activa un beacon al máximo nivel","icon":"💡","tier":5,"reward":3},
    {"name":"Allay","desc":"Encuentra y libera 2 Allays","icon":"🧚","tier":5,"reward":3},
    {"name":"Warden","desc":"Despierta y sobrevive al Warden","icon":"👹","tier":5,"reward":3},
    {"name":"Ancient City","desc":"Encuentra una Ancient City","icon":"🏛️","tier":5,"reward":3},
    {"name":"Swift Sneak","desc":"Consigue el encantamiento Swift Sneak","icon":"👟","tier":5,"reward":3},
    {"name":"Disco","desc":"Consigue 5 discos de música diferentes","icon":"💿","tier":5,"reward":3},
    {"name":"Huevo de Dragón","desc":"Consigue el huevo de dragón","icon":"🥚","tier":5,"reward":3},
    {"name":"Totem","desc":"Consigue un Totem de Inmortalidad","icon":"🧿","tier":5,"reward":3},
    {"name":"Tridente","desc":"Consigue un tridente","icon":"🔱","tier":5,"reward":3},
    {"name":"Conducto","desc":"Construye y activa un conducto","icon":"🌀","tier":5,"reward":3},
    {"name":"Hoguera","desc":"Coloca 10 hogueras","icon":"🔥","tier":5,"reward":3},
    {"name":"Mapa del Tesoro","desc":"Sigue un mapa del tesoro y encuentra el botín","icon":"🗺️","tier":5,"reward":3},
    {"name":"Pesca Legendaria","desc":"Pesca un libro encantado nivel 30","icon":"📖","tier":5,"reward":3},
    {"name":"Comerciante Supremo","desc":"Comercia 100 veces con aldeanos","icon":"💼","tier":5,"reward":3},
    {"name":"Encantamientos Máximos","desc":"Encanta un item con 5 encantamientos distintos","icon":"✨","tier":5,"reward":3},
    {"name":"Poción de Suerte","desc":"Crea una poción de suerte","icon":"🍀","tier":5,"reward":3},
    {"name":"Flecha con Efecto","desc":"Crea 10 flechas con efecto","icon":"🏹","tier":5,"reward":3},
    {"name":"Armadura con Protección","desc":"Encanta armadura completa con Protección IV","icon":"🛡️","tier":5,"reward":3},
    {"name":"Espada Legendaria","desc":"Encanta espada con Filo V, Saqueo III, Aspecto Ígneo II","icon":"⚔️","tier":5,"reward":3},
    {"name":"Pico Legendario","desc":"Encanta pico con Fortuna III, Eficiencia V, Irrompibilidad III","icon":"⛏️","tier":5,"reward":3},
    {"name":"Arco Legendario","desc":"Encanta arco con Poder V, Punch II, Llama I","icon":"🏹","tier":5,"reward":3},
    {"name":"Ballesta","desc":"Crea y encanta una ballesta","icon":"🎯","tier":5,"reward":3},
    {"name":"Pesca en Lava","desc":"Pesca en lava con caña de pescar","icon":"🌋","tier":5,"reward":3},
    {"name":"Granja de Hierro","desc":"Construye una granja de hierro funcional","icon":"⚙️","tier":5,"reward":3},
    {"name":"Granja de Oro","desc":"Construye una granja de oro en el Nether","icon":"🪙","tier":5,"reward":3},
    {"name":"Granja de Enderman","desc":"Construye una granja de Enderman","icon":"👾","tier":5,"reward":3},
    {"name":"Aldea Defendida","desc":"Defiende una aldea de una invasión","icon":"🛡️","tier":5,"reward":3},
    {"name":"Maestro del Comercio","desc":"Lleva un aldeano a maestro","icon":"👨‍🏫","tier":5,"reward":3},
    {"name":"Mansión","desc":"Encuentra una mansión del bosque","icon":"🏰","tier":5,"reward":3},
    {"name":"Monumento Oceánico","desc":"Explora un monumento oceánico","icon":"🏛️","tier":5,"reward":3},
    {"name":"Elder Guardian","desc":"Mata a un Elder Guardian","icon":"🐟","tier":5,"reward":3},
    {"name":"Montaña Nevada","desc":"Encuentra un bioma de montaña nevada","icon":"🏔️","tier":5,"reward":3},
    {"name":"Jungla","desc":"Encuentra una jungla y su templo","icon":"🌴","tier":5,"reward":3},
    {"name":"Sabana","desc":"Encuentra una aldea en la sabana","icon":"🌅","tier":5,"reward":3},
    {"name":"Acantilados de Tiza","desc":"Encuentra un bioma de tiza","icon":"⛰️","tier":5,"reward":3},
    {"name":"Cerezo","desc":"Encuentra un bioma de cerezos","icon":"🌸","tier":5,"reward":3},
    {"name":"Iniciar Sesión 4","desc":"Juega 100 horas totales","icon":"⏰","tier":5,"reward":3},
    {"name":"Día 100","desc":"Sobrevive 100 días","icon":"☀️","tier":5,"reward":3},
    {"name":"Maratón","desc":"Camina 100000 bloques totales","icon":"👣","tier":5,"reward":3},
    {"name":"Minero Experto","desc":"Excava 10000 bloques","icon":"⛏️","tier":5,"reward":3},
    {"name":"Arquitecto","desc":"Coloca 10000 bloques","icon":"🏗️","tier":5,"reward":3},
    {"name":"Cazador Experto","desc":"Mata 1000 mobs","icon":"⚔️","tier":5,"reward":3},
    {"name":"Amigo","desc":"Juega con 5 amigos diferentes","icon":"👥","tier":5,"reward":3},
    {"name":"Streamer","desc":"Transmite el server en vivo","icon":"📺","tier":5,"reward":3},
    {"name":"Guía","desc":"Ayuda a 3 jugadores nuevos","icon":"🧑‍🏫","tier":5,"reward":3},
    {"name":"Logro 100","desc":"Completa 100 logros diferentes","icon":"🏅","tier":5,"reward":3},
    {"name":"Veterano Supremo","desc":"Juega por 60 días diferentes","icon":"📅","tier":5,"reward":3},
    {"name":"Leyenda del Nether","desc":"Consigue todos los biomas del Nether","icon":"🔥","tier":6,"reward":5},
    {"name":"Leyenda del End","desc":"Explora todas las islas del End","icon":"🌀","tier":6,"reward":5},
    {"name":"Maestro del Nether","desc":"Mata a todos los mobs del Nether","icon":"👹","tier":6,"reward":5},
    {"name":"Coleccionista de Discos","desc":"Consigue todos los discos de música","icon":"💿","tier":6,"reward":5},
    {"name":"Armadura Suprema","desc":"Encanta armadura completa con Protección IV y Feather Falling IV","icon":"🛡️","tier":6,"reward":5},
    {"name":"Herramienta Suprema","desc":"Encanta un pico con 6 encantamientos","icon":"⛏️","tier":6,"reward":5},
    {"name":"Guerrero Supremo","desc":"Derrota a todos los jefes del juego","icon":"⚔️","tier":6,"reward":5},
    {"name":"Biblioteca Completa","desc":"Consigue todos los encantamientos nivel máximo","icon":"📚","tier":6,"reward":5},
    {"name":"Poción Suprema","desc":"Crea todos los tipos de pociones","icon":"🧪","tier":6,"reward":5},
    {"name":"Bestiario","desc":"Mata al menos 1 de cada mob del juego","icon":"📖","tier":6,"reward":5},
    {"name":"Explorador Supremo","desc":"Visita todos los biomas del Overworld","icon":"🌍","tier":6,"reward":5},
    {"name":"Comerciante Legendario","desc":"Lleva 5 aldeanos diferentes a maestro","icon":"👨‍🌾","tier":6,"reward":5},
    {"name":"Granjero Supremo","desc":"Cultiva todos los cultivos del juego","icon":"🌾","tier":6,"reward":5},
    {"name":"Minero Legendario","desc":"Consigue 64 de cada mineral","icon":"⛏️","tier":6,"reward":5},
    {"name":"Constructor Supremo","desc":"Construye una base de 50x50","icon":"🏰","tier":6,"reward":5},
    {"name":"Redstone Master","desc":"Construye una máquina compleja con 50+ componentes","icon":"🔌","tier":6,"reward":5},
    {"name":"Elytra","desc":"Vuela 10000 bloques con élitras","icon":"🪶","tier":6,"reward":5},
    {"name":"Velocidad","desc":"Alcanza velocidad máxima con élitras y fuegos artificiales","icon":"💨","tier":6,"reward":5},
    {"name":"Pesca Suprema","desc":"Pesca 500 veces","icon":"🎣","tier":6,"reward":5},
    {"name":"Asesino de Dragones","desc":"Derrota al Ender Dragon 5 veces","icon":"🐉","tier":6,"reward":5},
    {"name":"Matador de Wither","desc":"Derrota al Wither 3 veces","icon":"💀","tier":6,"reward":5},
    {"name":"Tesoro Supremo","desc":"Encuentra 10 cofres de tesoro","icon":"💎","tier":6,"reward":5},
    {"name":"Iniciar Sesión 5","desc":"Juega 250 horas totales","icon":"⏰","tier":6,"reward":5},
    {"name":"Día 365","desc":"Sobrevive un año entero","icon":"📅","tier":6,"reward":5},
    {"name":"Logro Completo","desc":"Completa 200 logros diferentes","icon":"🏆","tier":6,"reward":5},
    {"name":"Maestro de la Muerte","desc":"Muere de 10 formas diferentes","icon":"💀","tier":6,"reward":5},
    {"name":"Mapa Completo","desc":"Completa un mapa de área 4/4","icon":"🗺️","tier":6,"reward":5},
    {"name":"Aldea Suprema","desc":"Protege 3 aldeas diferentes de invasiones","icon":"🛡️","tier":6,"reward":5},
    {"name":"Marino","desc":"Explora un monumento oceánico completo","icon":"🌊","tier":6,"reward":5},
    {"name":"Conducto Máximo","desc":"Activa un conducto con 42 prismarina","icon":"🌀","tier":6,"reward":5},
    {"name":"Navegante","desc":"Navega 5000 bloques en bote","icon":"🚤","tier":6,"reward":5},
    {"name":"Montaraz","desc":"Recorre 5000 bloques en carro minero","icon":"🚂","tier":6,"reward":5},
    {"name":"Caballero","desc":"Recorre 5000 bloques a caballo","icon":"🐴","tier":6,"reward":5},
    {"name":"Célebre","desc":"Consigue 10 amigos en el server","icon":"👥","tier":6,"reward":5},
    {"name":"Eventos","desc":"Participa en 10 eventos del server","icon":"🎉","tier":6,"reward":5},
    {"name":"Donador","desc":"Ayuda a mejorar el server","icon":"💝","tier":6,"reward":5},
    {"name":"Staff","desc":"Conviértete en moderador del server","icon":"🛡️","tier":6,"reward":5},
    {"name":"Fundador","desc":"Ayuda a fundar algo en el server","icon":"👑","tier":6,"reward":5},
    {"name":"Membresía","desc":"Consigue una membresía","icon":"💳","tier":6,"reward":5},
    {"name":"Kit Premium","desc":"Canjea un kit de nivel 4+","icon":"📦","tier":6,"reward":5},
    {"name":"Monedas","desc":"Acumula 500 monedas totales","icon":"🪙","tier":6,"reward":5},
    {"name":"Gastador","desc":"Gasta 200 monedas en kits","icon":"💰","tier":6,"reward":5},
    {"name":"Ahorrador","desc":"Ahorra 100 monedas sin gastar","icon":"🏦","tier":6,"reward":5},
    {"name":"Logro Final","desc":"Completa TODOS los logros","icon":"👑","tier":6,"reward":5},
    {"name":"Leyenda Viva","desc":"Sé reconocido como leyenda del server","icon":"🌟","tier":6,"reward":5},
    {"name":"Inmortal","desc":"Juega por más de 500 horas","icon":"♾️","tier":6,"reward":5},
    {"name":"Día 500","desc":"Sobrevive 500 días","icon":"☀️","tier":6,"reward":5},
    {"name":"Campeón","desc":"Gana un torneo del server","icon":"🏆","tier":6,"reward":5},
    {"name":"Creador","desc":"Aporta una idea implementada en el server","icon":"💡","tier":6,"reward":5},
    {"name":"Historia","desc":"Sé parte de la historia del server","icon":"📜","tier":6,"reward":5}
  ],
  "mods": {
    "mods": [
      {"name":"🔧 Embeddium","desc":"Render optimizado (Sodium para Forge). +100 FPS","url":"https://www.curseforge.com/minecraft/mc-mods/embeddium","image":""},

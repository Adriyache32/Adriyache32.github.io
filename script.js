...
document.addEventListener('DOMContentLoaded', () => {
  if (!localStorage.getItem(SERVER_DATA_KEY)) {
    localStorage.setItem(SERVER_DATA_KEY, JSON.stringify({
      ...
      "team": [
        { "name": "Eliezer", "role": "Fundador", "color": "#7289da", "image": "" },
        { "name": "Manchitas", "role": "Fundador", "color": "#7289da", "image": "" },
        { "name": "Adriel", "role": "Moderador", "color": "#7289da", "image": "" },
        { "name": "Mellado", "role": "Moderador", "color": "#7289da", "image": "" }
      ],

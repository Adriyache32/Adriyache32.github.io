  ...
  switch (tab) {
    ...
    case 'kits': {
      const kdata = sd.kits || [
        ...
        { name: 'Bronce', price: 5, badge: '🟢 INICIAL', perks: ['🪖 Armadura: Casco de cuero, Peto de cuero, Pantalones de cuero, Botas de cuero', '⛏️ Herramientas: Pico de piedra, Hacha de piedra, Espada de piedra, Pala de piedra', '🍞 Comida: 10 manzanas doradas', '📦 Items: 16 antorchas, 1 Cama roja, 1 Mesa de trabajo', '🎁 Kit inicial especial', '🏷️ Tag coloreado en el chat', '⭐ Acceso a /fly en spawn'] },
        { name: 'Plata', price: 10, badge: '🔥 POPULAR', perks: ['🪖 Armadura: Casco de hierro, Peto de hierro, Pantalones de hierro, Botas de hierro', '⛏️ Herramientas: Pico de hierro (Fortuna I), Hacha de hierro (Eficiencia I), Espada de hierro (Filo I), Pala de hierro (Eficiencia I)', '🍞 Comida: 20 filetes de res', '📦 Items: 32 antorchas, 1 Cama azul, 5 Libros encantados', '🔮 Todo lo de Bronce', '🏠 Home adicional (3 total)', '📦 Acceso a /enderchest'] },
        { name: 'Oro', price: 20, badge: '⭐ RECOMENDADO', perks: ['🪖 Armadura: Casco de diamante, Peto de diamante, Pantalones de diamante, Botas de diamante', '⛏️ Herramientas: Pico de diamante (Fortuna III), Hacha de diamante (Eficiencia III), Espada de diamante (Filo III), Pala de diamante (Eficiencia III)', '🍞 Comida: 32 filetes de res, 16 pasteles de calabaza', '📦 Items: 1 Cofre de ender, 64 antorchas, 10 Obsidiana, 1 Perla de ender', '💰 10 monedas del server', '🪄 Todo lo de Plata', '🏠 5 Homes adicionales', '🔑 Acceso a /nick', '🎮 Rol exclusivo en Discord'] },
      ];

  ...
  switch (tab) {
    ...
    case 'kits': {
      const kdata = sd.kits || [
        ...
        { name: 'Bronce', price: 5, badge: '', perks: ['🪖 Armadura: Casco de cuero, Peto de cuero, Pantalones de cuero, Botas de cuero', '⛏️ Herramientas: Pico de piedra, Hacha de piedra, Espada de piedra, Pala de piedra', '🍞 Comida: 10 manzanas doradas', '📦 Items: 16 antorchas, 1 Cama roja, 1 Mesa de trabajo', '🎁 Kit inicial especial', '🏷️ Tag coloreado en el chat', '⭐ Acceso a /fly en spawn'] },
